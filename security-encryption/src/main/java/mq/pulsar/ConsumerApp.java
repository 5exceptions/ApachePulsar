...
public class ConsumerApp {
	...
	public static void main(String[] args) throws PulsarClientException {
		...
		PulsarConsumer consumer = new PulsarConsumer(serviceUrl, topicName, pulicKey, privateKey);
...
class PulsarConsumer {
	...
	// Constructor
	PulsarConsumer(String serviceUrl, String topicName, String pulicKey, String privateKey) {
